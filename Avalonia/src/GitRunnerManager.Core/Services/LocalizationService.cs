...
public class LocalizationService : ILocalizationService
{
    private static readonly ImmutableDictionary<string, string> _english = ImmutableDictionary<string, string>.Empty
        ...
        .Add(LocalizationKeys.GitHubSetupInstructionsBody, "Create a free OAuth App at https://github.com/settings/developers. Open OAuth Apps, create a new app, enable Device Flow, then paste the Client ID here. Repository runners require repository admin access. Organization runners require organization admin access and the admin:org scope.")
    ...
    private static readonly ImmutableDictionary<string, string> _hungarian = ImmutableDictionary<string, string>.Empty
        ...
        .Add(LocalizationKeys.GitHubSetupInstructionsBody, "Hozz létre ingyenes OAuth Appot itt: https://github.com/settings/developers. Nyisd meg az OAuth Apps részt, hozz létre új appot, kapcsold be a Device Flow-t, majd illeszd be ide a Client ID-t. Repository runnerhez repository admin jog kell. Organization runnerhez organization admin jog és admin:org scope kell.")
        .Add(LocalizationKeys.GitHubOAuthClientIdTitle, "OAuth Client ID")
